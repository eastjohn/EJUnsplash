...
class MainViewControllerTests: XCTestCase {
    ...
    func testSearchBarDelegateIsMainViewController() {
        ...
        XCTAssertTrue(sut.stickyHeaderView.searchBar.delegate === sut)
    }
    ...
    func testSearchBarTouched_ThenPresentSearchViewController() {
        ...
        _ = sut.searchBarShouldBeginEditing(sut.stickyHeaderView.searchBar)
    ...
    func testSearchBarShouldBeginEditing_ThenReturnFalse() {
        givenLoadedView()
        XCTAssertFalse(sut.searchBarShouldBeginEditing(sut.stickyHeaderView.searchBar))
    }
}
